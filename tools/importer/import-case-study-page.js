...
const PAGE_TEMPLATE = {
  ...
  urls: [
    ...
    'https://fiixsoftware.com/resource-center/case-studies/liberty-oilfield/',
  ],
  ...
  sections: [
    ...
    { id: 'case-study-intro', name: 'Case study intro', selector: ['div.case-studies-temp > .company-intro'], style: 'case-study-intro', blocks: ['case-study-logo', 'case-study-profiles', 'case-study-lead', 'stats-multi', 'solutions-comparison', 'youtube-video', 'columns-media'], defaultContent: [] },
